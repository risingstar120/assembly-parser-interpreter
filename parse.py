...
if not args.input:
   ...
   Script takes IPPCode24 as input, creates XML representation (encoding UTF-8) and sends it to output.

   Usage: python parser.py --input <file_name> [--output <file_name>]
   ''')
    exit(0)
...
reader = InputReader()
input_data = reader.get_input(args.input)
